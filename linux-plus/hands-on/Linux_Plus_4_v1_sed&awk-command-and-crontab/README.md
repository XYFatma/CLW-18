...
- Pick a workspace to develop your app in: AWS 17/TR
```
...
```bash
 ...
 - You can see the sample of your webhook cURL then
   forexample: " curl -X POST -H 'Content-type: application/json' --data '{"text":"Hello, World!"}' https://hooks.slack.com/services/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 "
```
